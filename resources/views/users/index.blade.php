    ...
    <main class="main-content" id="main-artist-list">
        <header class="content-header">
          <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <h1 class="page-title">Users <span class="totel-counts">({{ $records->firstItem() }} - {{ $records->lastItem() }} of {{ $records->total() }})</span></h1>
          </div>
        ...
        @if(count($records) > 0)
            ...
            <div class="artist-filter-tabs flex items-center space-x-2 overflow-x-auto mb-6">
                ...
                <button 
                    ...
                    All Users <span class="numbers-badge" id="count_all">{{ $tab_counts['all'] }}</span>
                </button>
            ...
            <div id="result">
                @include('users.ajax_all_records')
            </div>
        </div>
        @include('users._delete_popup')
        @else
            @include('users.empty_list')
        @endif
    </main> 
</x-dashboard-layout>