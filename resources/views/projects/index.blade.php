    ...
    <main class="main-content" id="main-artist-list">
        <header class="content-header">
          <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <h1 class="page-title">Projects <span class="totel-counts">({{ $records->firstItem() }} - {{ $records->lastItem() }} of {{ $records->total() }})</span></h1>
          </div>
            ...
            <div class="artist-filter-tabs flex items-center space-x-2 overflow-x-auto mb-6">
                ...
                <button 
                    ...
                    data-tab="all" data-default="all">
                     Projects <span class="numbers-badge" id="count_all">{{ $tab_counts['all'] }}</span>
                </button>
...
<?php /*
            ...
            */ ?>
            ...
            <div id="result">
                @include('projects.ajax_all_projects')
            </div>
        </div>
        @include('projects._delete_popup')
        @else
            @include('projects.empty_list')
        @endif
    </main> 
</x-dashboard-layout>